...
class Okx(Account):
    ...
    def __init__(self, wallet_info, chains: List) -> None:
    ...
    @retry
    async def okx_withdraw(self, min_amount, max_amount, token_name, terminate, skip_enabled, skip_threshold):
